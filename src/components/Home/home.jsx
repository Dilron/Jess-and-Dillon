            ...
            <div className='home-container' >
                <div className='home-splash mb-seperator' >
                    <section className='home-splash-box' >
                        ...
                        <h2>August 7, 2021</h2>
                        <h2>Soldier Hollow | Midway, UT</h2>
                        <h3>We are so excited to celebrate our marriage with you on August 7th next year! Although we will still be married on August 1st, 2020, we are rescheduling our wedding events to 2021 due to COVID. Please visit this website in the coming months to RSVP & stay in the loop on our wedding celebrations!
                ...
                <div className='home-info mb-seperator' >
                    ...
                    <section className='info-content' >
                        ...
                        <h2><b>For those invited to our ceremony this year, RSVP <a href="https://forms.gle/xPvhjDz4QSqdnjGx6" target="_blank" rel="noopener noreferrer">here</a> for August 1, 2020</b></h2>
                        <ul>
                            <li>Directions for the August 1st, 2020 ceremony coming soon</li>
